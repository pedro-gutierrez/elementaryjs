...
# Elm
Elementary kind of follows the `model-update-view` flow described by the [Elm architecture](https://guide.elm-lang.org/architecture/). Applications written with Elementary have a clean separation between logic and side effects.
## Small  and modular
